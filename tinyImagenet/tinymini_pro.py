#tinymini  dataset 3*64*64 total90000
import torch
import os
...
x_tr, y_tr = torch.load(os.path.join('tinymini_train.pt'))
x_te, y_te = torch.load(os.path.join('tinymini_test.pt'))
...
torch.save([tasks_tr, tasks_te], 'tinymini40_1.pt')