...
parser.add_argument('--i', default='cifar10.pt', help='input directory')
parser.add_argument('--o', default='cifar10_5.pt', help='output file')
...
cpt = int(10 / args.n_tasks)#每一类中的类别个数
u_y = y_tr.unique()
...
torch.save([tasks_tr, tasks_te], 'cifar10_5.pt')